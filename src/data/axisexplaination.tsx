// Chaque pôle porte, en plus de son argumentaire (`response`), une phrase-valeur
// courte et vouvoyée (`claim`) — « ce que ce résultat dit de vous » — affichée
// sous le mot du pôle dans le bloc « Vos convictions les plus fortes » des
// résultats et sur la carte de partage.
// Une seule ligne sur la carte 1080px : viser ≤ 65 caractères.
export const ideologicalAxes = [
  ...
  left: {
    label: "Progressisme",
    claim: "Vous voulez qu’on remette en cause les normes héritées.",
    response:
  ...
  right: {
    label: "Conservatisme",
    claim: "Vous tenez aux repères qui font tenir la société ensemble.",
    response:
  ...
  },
{
  ...
  left: {
    label: "Anarchisme",
    claim: "Vous vous méfiez de tout pouvoir qui ne se justifie pas.",
    response:
  ...
  right: {
    label: "Étatisme",
    claim: "Vous comptez sur un État fort pour garantir l’ordre commun.",
    response:
  ...
  left: {
    ...
    claim: "Vous voulez que l’État encadre le marché et ses dérives.",
    response:
  ...
  right: {
    ...
    claim: "Vous faites confiance au marché plus qu’à la bureaucratie.",
    response:
...
,{
  ...
  left: {
    ...
    claim: "Vous acceptez de renoncer à du confort pour la planète.",
    response:
  ...
  right: {
    label: "Productivisme",
    claim: "Vous misez sur l’innovation plutôt que sur la décroissance.",
    response:
...
, {
    ...
    left: {
      ...
      claim: "Vous voulez une économie qui partage plutôt qu’elle n’accumule.",
      response:
    ...
    right: {
      ...
      claim: "Vous croyez que l’envie d’entreprendre fait avancer la société.",
      response:
  ...
  },
  {
    ...
    left: {
      label: "Collectivisme",
      claim: "Vous voulez que l’essentiel appartienne à tous, pas à quelques-uns.",
      response:
    ...
    right: {
      ...
      claim: "Vous défendez le droit de posséder, de bâtir et de transmettre.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous voulez décider plus souvent qu’une fois tous les cinq ans.",
      response:
    ...
    right: {
      ...
      claim: "Vous préférez des élus qui tranchent et rendent des comptes.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous attendez de la justice qu’elle répare plutôt qu’elle n’exclue.",
      response:
    ...
    right: {
      ...
      claim: "Vous attendez de la justice des sanctions claires et appliquées.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous croyez à la coopération au-delà des frontières.",
      response:
    ...
    right: {
      label: "Souverainisme",
      claim: "Vous voulez que les lois se décident au pays, pas au-dessus de lui.",
      response:
  ...
  },
  {
    ...
    left: {
      label: "Laïcisme",
      claim: "Vous tenez à un État strictement neutre face aux religions.",
      response:
    ...
    right: {
      ...
      claim: "Vous voyez dans l’héritage spirituel un repère commun à assumer.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous croyez aux ruptures plus qu’aux retouches.",
      response:
    ...
    right: {
      label: "Réformisme",
      claim: "Vous préférez améliorer pas à pas que tout renverser.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous refusez que le travail soit la mesure d’une vie.",
      response:
    ...
    right: {
      label: "Travaillisme",
      claim: "Vous croyez au mérite et à la valeur du travail.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous refusez de troquer vos libertés contre de la sécurité.",
      response:
    ...
    right: {
      label: "Sécuritarisme",
      claim: "Pour vous, la sécurité est la première des libertés.",
      response:
  ...
  },
  {
    ...
    left: {
      ...
      claim: "Vous redoutez une technique qui s’impose sans débat.",
      response:
    ...
    right: {
      ...
      claim: "Vous voyez dans l’innovation la meilleure réponse à nos défis.",
      response:
